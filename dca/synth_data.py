...
def embedded_lorenz_cross_cov_mats(N, T, snr=1., noise_dim=7, return_samples=False,
                                   ...
                                   V_dynamics=None, V_noise=None, X_dynamics=None, seed=19940423):
...
def nl_embedded_lorenz_cross_cov_mats(N, T, snr=1., noise_dim=7, return_samples=False,
                                   num_lorenz_samples=10000, num_subspace_samples=5000,
                                   V_dynamics=None, V_noise=None, X_dynamics=None, seed=19940423, model=None):
